...
class CreateAdvertisementBinsns extends Component
{
    use WithFileUploads;
    ...
    public $vipSelected = false;
    public $bsnSelected = false;
    public $type = null;
    ...
    {
        if ($this->vipSelected) {
            $this->bsnSelected = false; // Зняти чекбокс BSN
            $this->type = 'VIP'; // Встановити тип VIP
        } else {
            $this->type = null; // Якщо знято чекбокс VIP, очистити тип
        }
    }

    public function toggleBsn()
    {
        if ($this->bsnSelected) {
            $this->vipSelected = false; // Зняти чекбокс VIP
            $this->type = 'BSN'; // Встановити тип BSN
        } else {
            $this->type = null; // Якщо знято чекбокс BSN, очистити тип
        }
    }
    ...
    public function render()
    {
        ...
        return view('livewire.create-advertisement-binsns', compact('categories'))->layout("layouts.base");
    }
